    ...
    switch (type) {
      ...
      case "generation":
        return (
          <div className="mt-3 p-3 bg-background/40 rounded-lg text-sm">
            <p className="mb-2">
              <strong>Example:</strong> Born in 1990
            </p>
            <p className="mb-1">
              <strong>Year:</strong> 1990 → 1 + 9 + 9 + 0 = 19 → 1 + 9 = 10 → 1 + 0 = 1
            </p>
      ...
      case "dayOfBirth":
        return (
          <div className="mt-3 p-3 bg-background/40 rounded-lg text-sm">
            <p className="mb-2">
              <strong>Example:</strong> Born on October 15
            </p>
      ...
      case "expression":
        return (
          <div className="mt-3 p-3 bg-background/40 rounded-lg text-sm">
            <p className="mb-2">
              <strong>Example:</strong> John Smith
            </p>
            <p className="mb-1">
              <strong>Letters:</strong> J(1) + O(6) + H(8) + N(5) + S(1) + M(4) + I(9) + T(2) + H(8)
            </p>
            <p className="mb-1">
              <strong>Sum:</strong> 1 + 6 + 8 + 5 + 1 + 4 + 9 + 2 + 8 = 44
            </p>
            <p className="mb-1">
              <strong>Reduced:</strong> 4 + 4 = 8
            </p>
      ...
      case "soulUrge":
        return (
          <div className="mt-3 p-3 bg-background/40 rounded-lg text-sm">
            ...
            <p className="mb-1">
              <strong>Vowels:</strong> O(6) + I(9)
            </p>
            <p className="mb-1">
              <strong>Sum:</strong> 6 + 9 = 15
            </p>
            <p className="mb-1">
              <strong>Reduced:</strong> 1 + 5 = 6
            </p>
      ...
      case "personality":
        return (
          <div className="mt-3 p-3 bg-background/40 rounded-lg text-sm">
            ...
            <p className="mb-1">
              <strong>Consonants:</strong> J(1) + H(8) + N(5) + S(1) + M(4) + T(2) + H(8)
            </p>
            <p className="mb-1">
              <strong>Sum:</strong> 1 + 8 + 5 + 1 + 4 + 2 + 8 = 29
            </p>
            <p className="mb-1">
              <strong>Reduced:</strong> 2 + 9 = 11 (master number, not reduced further)
            </p>
      ...
      case "maturity":
        return (
          <div className="mt-3 p-3 bg-background/40 rounded-lg text-sm">
            <p className="mb-2">
              <strong>Example:</strong> Life Path 8, Expression 6
            </p>
            <p className="mb-1">
              <strong>Sum:</strong> 8 + 6 = 14
            </p>
            <p className="mb-1">
              <strong>Reduced:</strong> 1 + 4 = 5
            </p>
  ...
  return (
    ...
    >
      ...
      <div className="p-8">
        ...
        >
          <h2 className="text-3xl font-medium mb-2">{insight.title}</h2>
        </motion.div>
