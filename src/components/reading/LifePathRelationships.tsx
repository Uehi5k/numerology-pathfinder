...
const LifePathRelationships: React.FC<LifePathRelationshipsProps> = ({ 
  lifePathNumber, 
  relationshipData 
}) => {
    ...
    <div className="space-y-8 mt-4">
      ...
      <div className="bg-background/40 p-5 rounded-xl border border-foreground/10 mt-6">
        <p className="text-sm text-foreground/70">
          ...
          While numerology can provide interesting insights into relationship dynamics, 
          it should not be the only factor considered when evaluating relationships. 
          Many other factors such as personal growth, communication skills, shared values, 
          and mutual respect are crucial elements of successful relationships.
        </p>
      </div>
    </div>
  );
