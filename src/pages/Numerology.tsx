  ...
  return (
    <Layout>
      <div className="flex flex-col items-center justify-center space-y-8 py-8">
        ...
        >
          <h1 className="text-3xl font-medium tracking-tight sm:text-4xl">Numerology Calculator</h1>
        ...
        <motion.div
          ...
          className="w-full max-w-4xl px-4"
        >
          <Accordion type="single" collapsible className="w-full glass dark:glass-dark rounded-xl p-4">
              ...
              <AccordionContent>
                <div className="space-y-4">
                  <div>
                    ...
                    <p>
                      Your Life Path number is calculated from your birth date. It reveals your life's purpose, destiny,
                  ...
                  <div>
                    ...
                    <p>
                      Calculated from all the letters in your full birth name. It reveals your natural abilities,
                      talents, and the traits you'll develop throughout life.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p>
                      Calculated from the vowels in your full birth name. It reveals your inner desires, motivations,
                      and what truly fulfills you.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p>
                      Calculated from the consonants in your full birth name. It reveals how others perceive you and the
